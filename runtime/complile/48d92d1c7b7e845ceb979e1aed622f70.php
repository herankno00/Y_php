...
<main>
  <div class="banner-inner">
	...
	<section class="common-main document-main">
		<div class="l-wrap">
			<ul class="download-list">
				{pboot:list num=20 order=sorting}
				<li>
					<div class="download-img"> <img src="[list:ico]" alt="[list:title]"> </div>
					<div class="download-info"> <div class="download-con"> <p class="download-name">[list:title]</p> </div> </div>
					<a class="download-btn" href="[list:enclosure]"> <i class="fa fa-download"></i> <span>Download</span> </a>
					</li>
				{/pboot:list}
			</ul>
			<div class="mypages">
