		...
		<div class="page-container">
			<aside class="sidebar">
				...
				<div class="sidebar-item recent-news">
					<p class="sidebar-title">Related Industry Knowledge</p>
					<ul class="recentnews-list">
					{pboot:nav num=10 parent={sort:tcode}}
						<li><a href="[nav:link]" class="line3"><em class="iconfont icon-xiangyoujiantou"></em>[nav:name]</a></li>
					{/pboot:nav}
					</ul>
				</div>
				<div class="sidebar-item recommended">
					<p class="sidebar-title">Recommended</p>
					<ul class="sidebar-prolist">
					{pboot:list scode={sort:tcode} num=6 order=sorting}
						<li><a href="[list:link]"><img data-src="[list:ico]" class="lazy" alt="[list:title len=18]" /></a>
							<div>
								<a href="[list:link]" class="line2">[list:title len=18]</a>
								<p class="line2">[list:description]</p>
							</div>
						</li>
					{/pboot:list}
					</ul>
			...
			<div class="page-main">
				<div class="newslist list0">
					{pboot:list num=10 order=sorting}
					<div class="newsitem">
						<div class="news-img">
							<a href="[list:link]">
								<img data-src="[list:ico]" data-sizes="354x0 768w,318x0 1024w,291x0 1280w,289x0 1366w,313x0 1440w,364x0 1600w" class="lazy" alt="[list:title]" />
							</a>
						</div>
						<div class="news-info">
							<div class="news-title"><a href="[list:link]" class="line2">[list:title]</a></div>
							<div class="news-date"><em class="iconfont icon-date"></em>[list:date style=Y-m-d]</div>
							<div class="news-text line3">[list:description]</div>
							<a href="[list:link]" class="news-btn">Details</a>
						</div>
					</div>
					{/pboot:list}
				</div>
				<div class="mypages">
					<ul>
						<li><a href='{page:index}'>First</a></li>
						<li><a href='{page:pre}'>Up</a></li>
						{page:numbar}
