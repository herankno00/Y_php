...
<div class="layui-body">
	...
	<blockquote class="layui-elem-quote layui-text-red" id="note">
		...
		<p>
			<i class="fa fa-info-circle" aria-hidden="true"></i>
			当前后台文件名为admin.php,不安全！不安全！不安全！请修改网站根目录文件admin.php的文件名。修改后，后台新访问地址为：你的域名/你改的文件名.php
		</p>
		<?php } ?>
	 	...
	 	<div class="layui-col-xs12 layui-col-md6">
			<table class="layui-table table-two">
				  ...
				  <tbody>
	                ...
	                <tr>
	                    <th>同创模板网</th>
	                    <td><a href="http://www.cnboco.com" target="_blank" style="color:#666">www.cnboco.com</a></td>
	                </tr>
...
<?php return array (
  0 => '/data/user/htdocs/apps/admin/view/default/common/head.html',
  1 => '/data/user/htdocs/apps/admin/view/default/common/foot.html',
); ?>