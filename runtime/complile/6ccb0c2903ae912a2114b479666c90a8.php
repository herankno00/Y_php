...
<main>
  ...
  <section class="common-main news-detail-main">
    <div class="l-wrap">
      <div class="page-container">
				...
				<form class="inquiry-form" action="{pboot:msgaction}"  method="post">
					<div id="feedbackForm">
						<div class="send-inquiry default">
							...
							<input type="text" name="mail" class="require" placeholder="E-mail:*">
							<textarea name="content" cols="30" rows="10" class="require" placeholder="Content*"></textarea>
        ...
        <div class="page-main">
          <div class="page-box-shadow">
            <h1 class="newscontent-title">{content:title}</h1>
            <div class="newscontent-date">
				<span><em class="iconfont icon-date"></em>{content:date style=Y-M-d}</span>
				<span class="news-views" id="page-content-view">Visits:{content:visits}</span>
				<span class="newsendinquiry">Leave a message</span>
			</div>
            <div class="newscontent-details">
				<article>
					<p align="center" style="padding-top:20px;"><img src="{content:ico}" border="0"/></p>
					<p>{content:content}</p>
					TAG:{pboot:tags id={content:id} scode={sort:tcode}}
