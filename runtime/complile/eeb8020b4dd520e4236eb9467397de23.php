    ...
    <div class="l-wrap">
      <article>
		<div class="about-vision-wrap">
			<div class="about-img"><img loading="lazy" src="{sort:ico}" /></div>

			<div class="about-info">
				<div class="home-des">{sort:subname}</div>
				<h4 class="home-title">{sort:def1}</h4>
				<div id="accordion" class="vision-list">
					{pboot:list num=10 order=sorting}
					<div class="item open">
						<div class="link">
							<p>[list:title]</p>
							<em class="icon-xiangxia2 iconfont"></em>
						</div>
						<div class="content">[list:content drophtml=1 len=350]</div>
					</div>
					{/pboot:list}
				</div>
			</div>
