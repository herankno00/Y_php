...
<main>
	...
	<section class="common-main document-main">
		<div class="l-wrap">
			<ul class="project-list faqs-list">
				{pboot:list num=10 order=sorting}
				<li>
					<div class="project-info {pboot:if('[list:i]'==1)}open{/pboot:if}">
						<p class="project-name">[list:title]</p>
						<div class="project-content" {pboot:if('[list:i]'==1)}style="display: block;"{/pboot:if}>[list:content drophtml=1]</div>
					</div>
				</li>
				{/pboot:list}
			</ul>
