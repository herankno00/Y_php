    ...
    <div class="l-wrap">
		<article>
			<div class="page-video">
				...
				<div id="pagevideo" class="swiper swiper-no-swiping">
					<div class="swiper-wrapper">
					{pboot:list num=100 order=sorting}
						<div class="item swiper-slide">
							<div class="video">
								<video controls preload="auto" width="560" height="315" poster="[list:ico]">
									<source src="[list:ext_videos]">
								</video>
							</div>

							<div class="info">
								<p class="line2">[list:title len=18]</p>
								<a href="[list:link]">Watch the full video <em class="icon-jiantou_xiangyou iconfont"></em></a>
							</div>
						</div>
					{/pboot:list}
					</div>
				...
				<div class="video-button-next"><em class="icon-jiantou_xiangyou iconfont"></em></div>
				<div class="video-button-prev"><em class="icon-jiantou_xiangzuo iconfont"></em></div>
			</div>
		</article>
    </div>
  </section>
